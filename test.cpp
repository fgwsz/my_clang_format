...
class Tttttttttttttttttttttttttttttttttttttttttttttttttttttest : Aaaaaa,
                                                                 Bbbbbbbbb {
public:
...
// 一般按名字来排，按空行分组(因为有些顺序是特定的)，注意下面有个 SortIncludes
// 选项
#include "b.h"
#include <lib/main.h>
#include "a.h"
...
// 我试了下PenaltyBreakBeforeFirstCallParameter = 19， PenaltyExcessCharacter =
// 10
...
Namespaces::Are::Pervasive::SomeReallyVerySuperDuperLooooooooongFunctionName(
    args);
// PenaltyBreakComment
